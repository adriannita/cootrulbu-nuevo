...
@ManagedBean(name = "despachadorController")
@SessionScoped
public class DespachadorController implements Serializable {

    @EJB
    private Com.DCAD.Models.DespachadorFacade ejbFacade;
    ...
    private DespachadorFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DespachadorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DespachadorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DespachadorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DespachadorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Despachador) {
                ...
                return getStringKey(o.getCodDespachador());
            } else {
