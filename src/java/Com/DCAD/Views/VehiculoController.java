...
import Com.DCAD.Models.VehiculoFacade;
...
public class VehiculoController implements Serializable {
    ...
    @EJB
    private Com.DCAD.Models.VehiculoFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsVehiculo(getFacade().findAll(), true);//getFacade().findAll();
    }
